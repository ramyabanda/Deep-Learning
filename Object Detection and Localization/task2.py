...
Original file is located at
    https://colab.research.google.com/drive/1iMkLdikb5KspCC7FCumRI_N1AZBeGJm_

Disclaimer: Obtained the DLStudio code form Professor Kak's Homepage at https://pypi.org/project/DLStudio/1.0.7/

To improve the accuracy of the 50% noise dataset, smoothing is a technique that helps almost blur the image helping sharper edges become soft. This technique in turn helps classify better in cases of high noise. In this task2 of HW 5, I tried various smoothing techniques from Kornia filters, PIL's ImageFilter.GaussianBlur etc. Eventually I ended up with the Gaussian Smoothing method which gave the best accuracies among them raising the 50% noise dataset from 20% to 59.7%.
"""
...
#####                This method gave the highest accuracy values for both the 50% and 80% noise dataset.                    ######
#####         However adding smoothing unnecessarily to the 0% and 20% noise made it perform worse than before.              ######
          ...
          class LOADnet2_Smooth(nn.Module):
              ...
              def __init__(self, skip_connections=True, depth=32):
                  ...
                  #self.smoothing = kf.GaussianBlur((3, 3), (1.5, 1.5))
                  self.depth = depth // 2
                  self.conv = nn.Conv2d(3, 64, 3, padding=1)
                  self.pool = nn.MaxPool2d(2, 2)
                  self.skip64 = DetectAndLocalize.SkipBlock(64, 64, 
  ...
  #dls.show_network_summary(model0)
  ...
  #detector.run_code_for_training_with_CrossEntropy_and_BCE_Losses(model20)
  ...
  #detector.run_code_for_training_with_CrossEntropy_and_BCE_Losses(model80)
